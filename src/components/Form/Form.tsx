  ...
  if (flag === true) {
    ...
    return (
      <div className="flex flex-wrap items-center gap-0.5">
        <div className="flex flex-wrap justify-center mx-auto bg-white shadow-xl h-3/4 w-9 md:min-w-[500px] ">
          <form
          ...
          >
            ...
            <div className="flex flex-col justify-center m-auto py-4 px-28 pt-12">
              ...
              <div className="flex items-center mb-2">
                ...
                <label
                  htmlFor="default-checkbox"
                  className="ms-2 text-red-400 text-[8px] dark:text-red-300 from-neutral-red pl-32"
                >
                  Change phoneNumber
                </label>
              </div>
        ...
        <div className="flex flex-wrap justify-center mx-auto shadow-xl bg-white h-3/4 full md:min-w-[500px]">
          <img
